...
class AlamofireCompanyInfoRepository: CompanyInfoRepository {
    ...
    let ex :[CompanyInfo] = [
        CompanyInfo(name: "Company A", imageURL: nil, price: "$100", rating: 4.5),
        CompanyInfo(name: "Company B", imageURL: nil, price: "$200", rating: 4.2),
        CompanyInfo(name: "Company C", imageURL: nil, price: "$150", rating: 4.8),
        CompanyInfo(name: "Company D", imageURL: nil, price: "$120", rating: 4.0),
        CompanyInfo(name: "Company E", imageURL: nil, price: "$120", rating: 4.0)
    ]
